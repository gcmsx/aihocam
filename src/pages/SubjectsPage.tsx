...
import { gradeTopics, GradeLevel, gradeNames } from '@/data/gradeData';
      ...
      <div className="p-4">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-semibold mb-4">
            {gradeNames[selectedGrade]} - Konular
          </h2>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {Math.floor(Math.random() * 5 + 1)} video
                    </p>
                  </div>
                  <Progress 
                    value={Math.floor(Math.random() * 100)} 
        ...
        <div className="mb-8">
          <h2 className="text-lg font-semibold mb-4">Tüm Videolar</h2>
